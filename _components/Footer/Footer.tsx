...
import MapCardIframe from "../MapCard/MapCard";
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-2">
                    <svg className="h-6 w-8 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                  <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
                </svg>
                <span className="text-sm font-bold text-white">Localisation</span>
                </div>
              <div className="mt-4">
                <MapCardIframe />
              </div>
            ...
            <div>
              ...
              <ul className="mb-8 space-y-3 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>+226 76 66 82 42</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>Fax: +226 70 23 06 90</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <Link href="https://www.somyecda.com" className="text-shadow-gray-50 hover:text-emerald-400">www.somyecda.com</Link>
                </li>
              </ul>
            </div>
